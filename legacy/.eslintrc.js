module.exports = {
  ...
  rules: {
    ...
    'no-multi-spaces': [               // http://eslint.org/docs/rules/no-multi-spaces
      ...
      { exceptions: { "VariableDeclarator": true, "Property": true, "ImportDeclaration": true} }
    ],
    ...
    'no-catch-shadow': [               // http://eslint.org/docs/rules/no-catch-shadow
      'off'                         // disallow `catch` clause parameters from shadowing variables in the outer scope
    ],
    ...
    'key-spacing': [                    // http://eslint.org/docs/rules/key-spacing
      'error', { "mode": "minimum" }    // enforce consistent spacing between keys and values in object literal properties
    ],
    ...
    'max-statements': [                // http://eslint.org/docs/rules/max-statements
      'error', 30                      // enforce a maximum number of statements allowed in function blocks
    ],
    ...
    'no-underscore-dangle': [          // http://eslint.org/docs/rules/no-underscore-dangle
      'off',                        // disallow dangling underscores in identifiers
      {allow: ['_id']}
    ],
    ...
    'no-var': [                        // http://eslint.org/docs/rules/no-var
      'off'                         // require `let` or `const` instead of `var`
    ],
    'object-shorthand': [             // http://eslint.org/docs/rules/object-shorthand
      'off'                         // require or disallow method and property shorthand syntax for object literals
    ],
    ...
    'prefer-rest-params': [            // http://eslint.org/docs/rules/prefer-rest-params
      'off'                         // require rest parameters instead of `arguments`
    ],
    ...
    'prefer-template': [               // http://eslint.org/docs/rules/prefer-template
      'off'                         // require template literals instead of string concatenation
    ],
